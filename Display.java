...
public class Display {
    ...
    static class DisplayArea {
        ...
        public DisplayArea() {
            ...
            Arrays.fill(this.currentText, this.FILLCHAR);
        }
        ...
        public DisplayArea(String currentText, int size) {
            ...
            for (int i = 0; i < this.currentText.length; i++) {
                this.currentText[i] = (i < currentText.length()) ? currentText.charAt(i) : this.FILLCHAR;
            }
        }

        public void setText(String text) {
            for (int i = 0; i < this.currentText.length; i++) {
                this.currentText[i] = (i < text.length()) ? text.charAt(i) : this.FILLCHAR;
            }
        }
    ...
    public void updateBatteryLevel() {
        ...
        this.screen.sendToScreen(this.screenDisplayAreas);
    }
